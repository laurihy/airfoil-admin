(function() {
  ...
  Morris.Donut = (function(_super) {
    ...
    Donut.prototype.redraw = function() {
      ...
      this.text1 = this.drawEmptyDonutLabel(cx, cy-10 , this.options.labelColor, 10, 400);
      this.text2 = this.drawEmptyDonutLabel(cx, cy , this.options.labelColor, 20, 800);
      ...
      this.setTitle(this.options.title,this.options.value)
      return _results;
    };
    ...
    Donut.prototype.setTitle = function(title, value) {
      var inner, maxHeightBottom, maxHeightTop, maxWidth, text1bbox, text1scale, text2bbox, text2scale;
      inner = (Math.min(this.el.width() / 2, this.el.height() / 2)) * 2 / 3;
      maxWidth = 1.6 * inner;
      ...
      this.text1.attr({
        transform: "S" + text1scale + "," + text1scale + "," + (text1bbox.x + text1bbox.width / 2) + "," + (text1bbox.y + text1bbox.height/2+20)
      })
      ...
      return this.text2.attr({
        transform: "S" + text2scale + "," + text2scale + "," + (text2bbox.x + text2bbox.width / 2) + "," + (text2bbox.y + text2bbox.height/2-5)
      })
    }
  ...
  Morris.DonutSegment = (function(_super) {
    ...
    function DonutSegment(cx, cy, inner, outer, p0, p1, color, backgroundColor, index, raphael) {
      ...
      this.path = this.calcSegment(this.inner + 20, this.inner + this.outer);
      this.selectedPath = this.calcSegment(this.inner + 20, this.inner + this.outer);
